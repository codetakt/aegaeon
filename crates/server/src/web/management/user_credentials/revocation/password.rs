...
use workflow::revoke_user_password_credential_inner;

pub(in crate::web::management::user_credentials) async fn revoke_user_password_credential(
    ...
    match revoke_user_password_credential_inner(&context, user_id, &ctx.request_id).await {
