...
use crate::management::types::CreateTenantRequest;
use axum::{
    extract::{Path, State},
...
use workflow::create_tenant_inner;

pub(in crate::web::management::topology) async fn create_tenant(
    ...
    match create_tenant_inner(pool, &params, &req, &session, &ctx.request_id).await {
