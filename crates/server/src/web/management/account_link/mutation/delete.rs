...
use workflow::delete_account_link_inner;

pub(in crate::web::management::account_link) async fn delete_account_link(
    ...
    match delete_account_link_inner(pool, &params, &session, &ctx.request_id).await {
