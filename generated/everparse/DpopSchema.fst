(* GENERATED — renamed copy of Dpop.fst to avoid F* module name conflict with dpop/Dpop.fst.
   Source: generated/everparse/Dpop.fst (from schemas/Dpop.3d via EverParse).
   If Dpop.3d is regenerated, this file must be re-synced:
     sed 's/^module Dpop$/module DpopSchema/' generated/everparse/Dpop.fst > generated/everparse/DpopSchema.fst *)
module DpopSchema
