...
PROOFS=(
	...
	"end_to_end_authentication,ds_idtoken_verified_reachable"
	...
	"account_isolation,link_requires_honest_idp,linked_session_reachable"
	...
	"chain_unforgeability,rp_trusted_via_chain_reachable"
